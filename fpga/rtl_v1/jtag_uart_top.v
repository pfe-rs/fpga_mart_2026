...
module jtag_uart_top (
    ...
    // input  wire [2:0]  KEY,
    // // 2 cifre za banane
    output wire [6:0]  HEX1,        // 7-segmentna cifra 0
    output wire [6:0]  HEX3        // 7-segmentna cifra 1
    // // 2 cifre za kusur
    // output wire [6:0]  HEX4,        // 7-segmentna cifra 2
    // output wire [6:0]  HEX5,        // 7-segmentna cifra 3
    // // signal za bananu
    // output wire        BANANA
);
