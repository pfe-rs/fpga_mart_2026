...
module jtag_uart_top (
    input wire         CLOCK_50,
    input wire         RSTN,
    // // 3 dugmica za 20, 10, 5
    // input  wire [2:0]  KEY,
    // // 2 cifre za banane
    output wire [6:0]  HEX0_N,        // 7-segmentna cifra 0
    output wire [6:0]  HEX1_N,        // 7-segmentna cifra 1
    // // 2 cifre za kusur
    output wire [6:0]  HEX4_N,        // 7-segmentna cifra 2
    output wire [6:0]  HEX5_N        // 7-segmentna cifra 3
    ...
    wire [6:0] HEX0_N_w, HEX1_N_w, HEX4_N_w, HEX5_N_w;
    ...
    assign HEX0_N = HEX0_N_w;
    assign HEX1_N = HEX1_N_w; 
    assign HEX4_N = HEX4_N_w;
    assign HEX5_N = HEX5_N_w;
endmodule
