module pfe_chip (
    ...
    // 2x 7-segment display = 14 signala
    output wire sedam_seg_0_o,
    output wire sedam_seg_1_o,
    output wire sedam_seg_2_o,
    output wire sedam_seg_3_o,
    output wire sedam_seg_4_o,
    output wire sedam_seg_5_o,
    output wire sedam_seg_6_o,
    output wire sedam_seg_7_o,
    output wire sedam_seg_8_o,
    output wire sedam_seg_9_o,
    output wire sedam_seg_10_o,
    output wire sedam_seg_11_o,
    output wire sedam_seg_12_o,
    output wire sedam_seg_13_o,
    ...
    // switch
    sg13g2_IOPadIn      pad_sw0_i (.pad(sw0_i), .p2c(soc_sw0_i));

    // 7-seg
    sg13g2_IOPadOut16mA pad_sedam_seg_0_o  (.pad(sedam_seg_0_o),  .c2p(soc_sedam_seg_o[0]));
    sg13g2_IOPadOut16mA pad_sedam_seg_1_o  (.pad(sedam_seg_1_o),  .c2p(soc_sedam_seg_o[1]));
    sg13g2_IOPadOut16mA pad_sedam_seg_2_o  (.pad(sedam_seg_2_o),  .c2p(soc_sedam_seg_o[2]));
    sg13g2_IOPadOut16mA pad_sedam_seg_3_o  (.pad(sedam_seg_3_o),  .c2p(soc_sedam_seg_o[3]));
    sg13g2_IOPadOut16mA pad_sedam_seg_4_o  (.pad(sedam_seg_4_o),  .c2p(soc_sedam_seg_o[4]));
    sg13g2_IOPadOut16mA pad_sedam_seg_5_o  (.pad(sedam_seg_5_o),  .c2p(soc_sedam_seg_o[5]));
    sg13g2_IOPadOut16mA pad_sedam_seg_6_o  (.pad(sedam_seg_6_o),  .c2p(soc_sedam_seg_o[6]));
    sg13g2_IOPadOut16mA pad_sedam_seg_7_o  (.pad(sedam_seg_7_o),  .c2p(soc_sedam_seg_o[7]));
    sg13g2_IOPadOut16mA pad_sedam_seg_8_o  (.pad(sedam_seg_8_o),  .c2p(soc_sedam_seg_o[8]));
    sg13g2_IOPadOut16mA pad_sedam_seg_9_o  (.pad(sedam_seg_9_o),  .c2p(soc_sedam_seg_o[9]));
    sg13g2_IOPadOut16mA pad_sedam_seg_10_o (.pad(sedam_seg_10_o), .c2p(soc_sedam_seg_o[10]));
    sg13g2_IOPadOut16mA pad_sedam_seg_11_o (.pad(sedam_seg_11_o), .c2p(soc_sedam_seg_o[11]));
    sg13g2_IOPadOut16mA pad_sedam_seg_12_o (.pad(sedam_seg_12_o), .c2p(soc_sedam_seg_o[12]));
    sg13g2_IOPadOut16mA pad_sedam_seg_13_o (.pad(sedam_seg_13_o), .c2p(soc_sedam_seg_o[13]));
