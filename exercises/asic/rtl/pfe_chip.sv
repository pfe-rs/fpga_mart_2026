module pfe_chip (
  ...
  inout wire VSSIO
    ...
    sg13g2_IOPadOut16mA   pad_out_data_8_o  (.pad(out_data_8_o),  .c2p(soc_out_data_o[8]));
    sg13g2_IOPadOut16mA   pad_out_data_9_o  (.pad(out_data_9_o),  .c2p(soc_out_data_o[9]));
