...
set chipH    2000; # FIX OR die height (top to bottom)
set chipW    2000; # FIX OR die width (left to right)
...
###############################################################################
set bank0_sram0 {i_fifo_soc/i_fifo_in/gen_sram.gen_bank\[0\].i_sram} ;# FIX
set bank1_sram0 {i_fifo_soc/i_fifo_in/gen_sram.gen_bank\[1\].i_sram} ;# FIX
set bank2_sram0 {i_fifo_soc/i_fifo_in/gen_sram.gen_bank\[2\].i_sram} ;# FIX
set bank3_sram0 {i_fifo_soc/i_fifo_in/gen_sram.gen_bank\[3\].i_sram} ;# FIX
...
set sram_gap_x 80 ;# FIX
set sram_gap_y 80 ;# FIX

set XL [expr {$floor_midpointX - $sram_gap_x/2 - $RamSize256x8_W}] ;# FIX
set XR [expr {$floor_midpointX + $sram_gap_x/2}] ;# FIX
set YB [expr {$floor_midpointY - $sram_gap_y/2 - $RamSize256x8_H}] ;# FIX
set YT [expr {$floor_midpointY + $sram_gap_y/2}] ;# FIX

placeInstance $bank0_sram0 $XL $YT R0 ;# FIX
placeInstance $bank1_sram0 $XR $YT R0 ;# FIX
placeInstance $bank2_sram0 $XL $YB R0 ;# FIX
placeInstance $bank3_sram0 $XR $YB R0 ;# FIX
